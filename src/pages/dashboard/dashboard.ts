...
export class DashboardPage {
    ...
    LineCharts: any; // HighCharts is BarCharts
        ...
        let hideFooterTimeout = setTimeout( () => {
          ...
          this.ColumnCharts = {
            ...
            series: [{
                ...
                data: [this.inprogresscount+this.donecount]
            }, {
          ...
          // HighCharts is LineCharts
          this.LineCharts = {
            chart: {
                type: 'areaspline'
            },
            title: {
                text: 'ผลสรุปเปรียบเทียบงานที่เสร็จตามเวลา และล่าช้า'
            },
            xAxis: {
                categories: [
                    '',
            ...
            series: [{
                name: 'งานทั้งหมดที่ทำเสร็จตามเวลา',
                data: [0, this.PerformanceOnTime, 0]
            }, {
                name: 'งานทั้งหมดที่ทำเสร็จล่าช้า',
                data: [0, this.PerformanceDelay, 0]
            }]
            // chart: {
            //   type: 'column',
            // },
            // colors: ['#50B432', '#f73838'],
            // title: {
            //     text: 'ผลสรุปเปรียบเทียบงานที่เสร็จตามเวลา และล่าช้า'
            // },
            // xAxis: {
